...
class Intellisense extends Twig_Extension
{
    ...
    public function getFunctions()
    {
        return [
            ...
            new Twig_SimpleFunction('set_title', 'Phalcon\\Tag::setTitle'), 
            new Twig_SimpleFunction('set_title_separator', 'Phalcon\\Tag::setTitleSeparator'), 
            new Twig_SimpleFunction('append_title', 'Phalcon\\Tag::appendTitle'), 
            new Twig_SimpleFunction('prepend_title', 'Phalcon\\Tag::prependTitle'), 
            ...
            new Twig_SimpleFunction('set_doc_type', 'Phalcon\\Tag::setDocType'), 
            new Twig_SimpleFunction('get_doc_type', 'Phalcon\\Tag::getDocType'), 
